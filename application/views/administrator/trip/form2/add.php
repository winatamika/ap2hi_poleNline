                  ...
                  <tbody>
                    ...
                    <tr>
                            <th width='120px' scope='row'>waktu</th>   
                             <td><input type='text' class='form-control' name='waktu' required></td>
                    </tr>
                  
                    <tr>
                            <th width='120px' scope='row'>lintang</th>   
                             <td><input type='text' class='form-control' name='lintang'  required></td>
                    </tr>

                    <tr>
                            <th width='120px' scope='row'>bujur</th>   
                             <td><input type='text' class='form-control' name='bujur'  required></td>
                    </tr>
