...
<link rel="stylesheet" href="<?php echo base_url(); ?>/assets/admin/assets/css/pe-icon-7-filled.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>/assets/admin/assets/css/flag-icon.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>/assets/admin/assets/css/cs-skin-elastic.css">
